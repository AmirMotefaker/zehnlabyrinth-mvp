...
- 9,000 total stages remain the catalogue contract
- 9,000 unique fingerprints
- 0 unsolved
- 0 invalid
...
Each completed stage records at least:

- age band
- difficulty
- stage identity
- final elapsed time (frozen at completion)
- move count
- best time
- completion state

The result UI must visibly confirm completion and show final time + move count before progression.
